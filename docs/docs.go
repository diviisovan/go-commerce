...
const docTemplate = `{
        ...
        "/auth/change-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Validation or password policy failure",
                        "schema": {
    ...
    "definitions": {
        ...
        "models.RefreshRequest": {
            ...
            "properties": {
                "refresh_token": {
                    "type": "string",
                    "example": "v2.V0hFTiBJTiBET1VCVCwgcmVhZCB0aGUgZG9jcw"
                }
            }
        },
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "Role drives authorization checks in middleware.RequireRole.",
                    "type": "string",
                    "example": "customer"
                },
                "updated_at": {
    ...
    "securityDefinitions": {
        "BearerAuth": {
            "description": "Paste your access token here as: Bearer \u003ctoken\u003e",
            "type": "apiKey",
            "name": "Authorization",
            "in": "header"
        }
...
var SwaggerInfo = &swag.Spec{
	...
	Title:            "eCommerce API",
	Description:      "A comprehensive eCommerce system API with product management, shopping cart, and order processing",
